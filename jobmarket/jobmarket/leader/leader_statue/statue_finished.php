...
$sql .= "AND (control='Ok' OR control='False')";
$params = [];
$types = "";
...
if ($result->num_rows > 0) {
    echo "<table border='1'>";
    echo "<thead> <tr> <th>ID zakázky</th> <th>ID práce</th> <th>Název práce</th> <th>Hodinová sazba</th> <th>Předpokládaný začátek</th> <th>Počet hodin</th> <th>Výdělek</th> <th>ID pracovníka</th> <th>Název pracovníka</th> <th>Rodné číslo pracovníka</th> <th>Hpp</th><th>Daň</th><th>Začátek práce</th><th>Konec práce</th><th>Kontrola</th></tr> </thead>";
    echo "<tbody>";
    echo "<td></td>";
    // Zobrazení dat
