...
<body>
    ...
    <H1>Menu zpožděné zakázky </H1>
    <!-- toto je menu zamestnavatele-->
    <header>
        <div class="container">
    ...
    <h1>Třídit zpožděné zakázky podle:</h1>
    <form action="statue_delay.php" method="POST">
        ...
        <input type="number" id="salary" name="salary" placeholder="Zadejte minimální plat plat">
        <br><br>
    ...
    $sql .= " AND NOW() > DATE_ADD(begin_event, INTERVAL hours HOUR) ";
...
// HTML tabulka
    if ($result->num_rows > 0) {
        echo "<table border='1'>";
        echo "<thead> <tr> <th>ID zakázky</th> <th>ID práce</th> <th>Název práce</th> <th>Hodinová sazba</th> <th>Předpokládaný začátek</th> <th>Počet hodin</th> <th>Výdělek</th> <th>ID pracovníka</th> <th>Název pracovníka</th> <th>Rodné číslo pracovníka</th> <th>Hpp</th><th>Daň</th>   </tr> </thead>";
        echo "<tbody>";
        echo "<td></td>";
        // Zobrazení dat
