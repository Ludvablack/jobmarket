...
<body>
    ...
    if ($_SERVER['REQUEST_METHOD'] !== 'POST') {
        ?>
        <h1>Vybrat podle:</h1>
        <form action="manager_erase.php" method="POST">
...
//Hodnoty se připojují pomocí připraveného dotazu (Prepared Statements), což chrání před SQL injection útoky.
        ...
        if ($result->num_rows > 0) {
            ...
            <form action="manager_erase.php" method="POST">
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<tr>";
                    echo "<td><input type='radio' name='uzivatel_id' value='" . $row['id'] . "'></td>";
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['uzivatel_id'])) {
        ...
        if (isset($_POST['uzivatel_id'])) {
            ...
            <meta http-equiv="refresh" content="2;url=manager_erase2.php">
            </meta>
            <?php
