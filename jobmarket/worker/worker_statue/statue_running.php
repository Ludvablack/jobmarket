...
<head>
    ...
    <title>Přehled probíhajících zakázek</title>
    <link rel="stylesheet" href="../../CSS/style.css">
</head>

<body>
    <h1>Přehled probíhajících zakázek </h1>
    ...
    $sql = "SELECT * FROM event 
        WHERE id_worker = ?
          ...
          AND (stop_event IS NULL OR stop_event < '1970-01-01')
          AND control='Ready'
          ";
...
// HTML tabulka
    if ($result->num_rows > 0) {
        echo "<table border='1'>";
        echo "<thead> <tr> <th>ID zakázky</th> <th>ID práce</th> <th>Název práce</th> <th>Hodinová sazba</th> <th>Předpokládaný začátek</th> <th>Počet hodin</th> <th>Výdělek včetně daně</th> <th>ID pracovníka</th>    <th>Start</th> <th>Stop</th> </tr> </thead>";
        echo "<tbody>";
        echo "<td></td>";
        // Zobrazení dat
