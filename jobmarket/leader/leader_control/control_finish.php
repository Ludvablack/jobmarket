...
<head>
    ...
    <title>Schvalování zakázek</title>
...
<body>
    ...
    <H1>Menu schvalování zakázek</H1>
    <!-- toto je menu zakázky-->
    <header>
        <div class="container">
    ...
    <form action="control_finish.php" method="POST">
    ...
    $sql .= " AND stop_event IS NOT NULL ";
    $sql .= " AND stop_event > '1970-01-01' ";
    $params = [];
    $types = "";
...
// HTML tabulka
            if ($result->num_rows > 0) {
                ...
                ?>
                <form action="control_finish.php" method="POST">
                    <button><input type="submit" value="Zkontrolovat vybranou zakázku"></button>
                    <br><br>
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['uzivatel_id'])) {
        ...
        if (isset($_POST['uzivatel_id'])) {
            ...
            ?>
                ...
                <meta http-equiv="refresh" content="2;url=control_finish2.php">
                </meta>
                <?php
